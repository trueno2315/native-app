    ...
    return (
      <View style={styles.container}>
        <View style={styles.textStyle}>
          <Text style={{fontSize: 18, fontWeight: 'bold'}}>11.疲労感</Text>
        </View>
