    ...
    return (
      <View style={styles.container}>
        <View style={styles.textStyle}>
          <Text style={{fontSize: 18, fontWeight: 'bold'}}>6.味覚の変化</Text>
        </View>
