    ...
    return (
      <View style={styles.container}>
        <View style={styles.textStyle}>
          <Text style={{fontSize: 18, fontWeight: 'bold'}}>7.嘔吐</Text>
        </View>
