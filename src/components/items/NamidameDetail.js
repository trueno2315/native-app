    ...
    return (
      <View style={styles.container}>
        <View style={styles.textStyle}>
          <Text style={{fontSize: 18, fontWeight: 'bold'}}>1. アレルギー</Text>
        </View>
